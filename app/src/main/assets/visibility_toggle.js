function showCredits() {
    if (document.getElementById('credits')) return; // Avoid re-injection

    const creditBtn = document.createElement('div');
    creditBtn.className = 'glass-button';
    creditBtn.innerHTML = `<div id="credits" >
                               <strong>Redesigned with
    ...
    // Add event listener to the newly created div for the click event
    creditBtn.querySelector('#credits').addEventListener('click', openCredits);
